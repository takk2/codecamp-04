      ...
      <Page>
        ...
        <Wrapper>
          <Container>  
            ...
            <Password>
              <Label>비밀번호</Label>
              <InputPW type="password" placeholder="비밀번호를 입력해주세요." onChange={props.bbb} />
              <Info>{props.Error2}</Info>
            </Password>
          </Container>
          <Title>
            <Label>제목</Label>
            <TitleBox type="text" placeholder="제목을 작성해주세요." onChange={props.ccc} />
            <Info>{props.Error3}</Info>
          </Title>
          <Body>
            <Label>내용</Label>
            <BodyText placeholder="내용을 작성해주세요." onChange={props.ddd}></BodyText>
